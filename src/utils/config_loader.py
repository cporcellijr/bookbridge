...
ALL_SETTINGS = [
    ...
    # Kavita
    'KAVITA_ENABLED', 'KAVITA_SERVER', 'KAVITA_API_KEY', 'KAVITA_LIBRARY_ID', 'KAVITA_COLLECTION_NAME', 'KAVITA_OPDS_URL', 'KAVITA_KOSYNC_USER',

    # Stump
    'STUMP_ENABLED', 'STUMP_SERVER', 'STUMP_API_KEY',
